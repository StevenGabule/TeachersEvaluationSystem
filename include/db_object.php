...
class DB_Object
{
    ...
    {
        return static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE category_id = $id ORDER BY category_id DESC LIMIT 8");
    }
    ...
    public function update_feature($id)
    {
        ...
        $db->query($sql);
        return (int)mysqli_affected_rows($db->connection) === 1;
    }
