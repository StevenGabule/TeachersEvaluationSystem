...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $name = $_POST['subject'];
    $res = $subject->saveSubject($name);

    if ($res) {
        $session->message('<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Success!</strong> Successfully added a new subject info.
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" placeholder="Enter name" class="form-control">
                            </div>
                            <div class="form-group">
