...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $teacher = new Teacher();
    $res = $teacher->saveTeacher($name, $bachelor);
    if ($res) {
        $session->message('<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Success!</strong> Successfully added a new teacher info.
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bachelor" placeholder="Enter bachelor" class="form-control">
                            </div>
                            <div class="form-group">
